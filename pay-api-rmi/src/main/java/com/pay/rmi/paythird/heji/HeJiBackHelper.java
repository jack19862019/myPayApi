...
@Component
public class HeJiBackHelper extends CallBackFactory {

    private String flagSuccess = "success";

    public HeJiBackHelper init(McpConfigEntity mcpConfig, OrderEntity order, Map<String, String> params) {
    ...
    public HeJiBackHelper checkStatus() {
        String tradeStatus = callBackParams.get("status");
        Assert.mustBeTrue("2".equals(tradeStatus), "支付未成功，终止通知下游！");
        return this;
    }

    public HeJiBackHelper updateOrder() {
        String trade_no = callBackParams.get("mchOrderNo");
